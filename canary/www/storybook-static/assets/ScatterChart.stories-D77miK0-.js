import{e as t}from"./iframe-W8kdQUhq.js";import{g as p}from"./utils-ePvtT4un.js";import{S as s}from"./ScatterChartArgs-Bxm12dUp.js";import{a as d}from"./Coordinate-geWwP0Ct.js";import{S as m}from"./ScatterChart-Ci42Zv4L.js";import{R as g}from"./arrayEqualityCheck-Btlzc28s.js";import{X as l}from"./XAxis-DWhw38Xj.js";import{Y as S}from"./YAxis-BQfmZ2qg.js";import{S as h}from"./Scatter-DJEg_Cpl.js";import{R as f}from"./RechartsHookInspector-BcT8fmlt.js";const A={argTypes:s,component:m},e={name:"Simple",render:n=>{const{data:i,...c}=n;return t.createElement(g,{width:"100%",height:400},t.createElement(m,{...c},t.createElement(l,{dataKey:"x"}),t.createElement(S,{dataKey:"y"}),t.createElement(h,{data:i}),t.createElement(f,null)))},args:{...p(s),data:d,margin:{top:0,right:0,bottom:0,left:0}}};var r,a,o;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {
    const {
      data,
